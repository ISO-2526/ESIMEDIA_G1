...
import com.esimedia.accounts.dto.request.CreateAdminRequestDTO;
import com.esimedia.accounts.dto.request.CreateCreatorRequestDTO;
import com.esimedia.accounts.dto.request.SetActiveRequestDTO;
...
public class AdminController {
	...
	private void updateAdminFields(Admin existing, Map<String, Object> body) {
		...
		if (body.containsKey(DEPARTMENT) && body.get(DEPARTMENT) instanceof String) {
			try {
				var dep = com.esimedia.accounts.model.Department.valueOf(((String) body.get(DEPARTMENT)).trim());
